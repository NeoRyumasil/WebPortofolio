...
export default function NavBar() {
    ...
    return (
        <nav className="flex justify-between items-center py-6 px-6 md:px-12 bg-white sticky top-0 z-50 shadow-sm">
            ...
            {/* Menu Button */}
            <ul className="hidden md:flex gap-8 md:gap-8 text-sm font-bold text-gray-600 tracking-wider">
            ...
            <div className={`md:hidden bg-white border-t transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-64' : 'max-h-0'}`}>
                <ul className="flex flex-col text-right p-6 gap-4 text-sm text-gray-600 tracking-wider">
