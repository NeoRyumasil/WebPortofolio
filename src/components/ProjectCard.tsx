...
export default function ProjectCard({ title, imageSrc, desc, link, stack, category }: ProjectCardProps) {
    return (
        <div className="group relative w-[300px] md:w-[500px] bg-white rounded-2xl overflow-hidden shadow-md border border-gray-100 transition-all duration-300 hover:shadow-xl hover:translate-y-1">
            ...
            <div className="p-5 flex flex-col min-h-[300px]">
                ...
                {/* Description */}
                <p className="text-sm text-gray-600 leading-relaxed mb-6 line-clamp-7 text-justify">
                    {desc}
                </p>    
