...
export default function ProjectCard({ title, imageSrc, desc, link, stack, category }: ProjectCardProps) {
    return (
        <div className="group relative w-full max-w-[720px] bg-white rounded-2xl overflow-hidden shadow-md border border-gray-100 transition-all duration-300 hover:shadow-xl hover:translate-y-1">
